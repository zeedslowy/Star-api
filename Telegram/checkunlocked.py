...
api_token = 'token_buraya_gir_heval'
...
def start(message):
    ...
    button1 = telebot.types.InlineKeyboardButton("🥷𝚂𝙰𝙷𝙸𝙿 🥷", url="https://t.me/dijvarhack")
    button2 = telebot.types.InlineKeyboardButton("👻ᴋᴀɴᴀʟ👻", url="https://t.me/dijvarhack")
    button3 = telebot.types.InlineKeyboardButton("🍓𝐂𝐇𝐀𝐓🍓", url="https://t.me/dijvarhack")
    markup.add(button1, button2, button3)
    bot.reply_to(message, "👋 @Dijvarhack 𝚂𝚘𝚛𝚞𝚐𝚞 𝚋𝚘𝚝𝚞𝚗𝚊 𝚑𝚘𝚜̧𝚐𝚎𝚕𝚍𝚒𝚗 /sorgular 𝚢𝚊𝚣𝚊𝚛𝚊𝚔 𝚔𝚘𝚖𝚞𝚝𝚕𝚊𝚛ｪ 𝚘̈𝚐𝚛𝚎𝚗𝚎𝚋𝚒𝚕𝚒𝚛𝚜𝚒𝚗 𝚒𝚢𝚒 𝚜𝚘𝚛𝚐𝚞𝚕𝚊𝚛.", reply_markup=markup)
