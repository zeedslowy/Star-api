...
def send_sms(message):
    ...
    if len(args) != 2:
        bot.reply_to(message, "Tel No ve Adet Girin Örn: 555* 10")
        return
    phone_number = args[0]
    sms_count = int(args[1])

    bot.reply_to(message, f"SMS gönderimi başlıyor. Bittiğinde Bildirilecek!")
    ...
    bot.reply_to(message, f"{sms_count} adet SMS gönderimi tamamlandı.")
