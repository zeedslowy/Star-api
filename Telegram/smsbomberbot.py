...
def botu_baslatma(message):
    bot.reply_to(message, "@Kaizercheck 𝑆𝑜𝑟𝑔𝑢 𝐵𝑜𝑡'𝑢𝑛𝑎 𝐻𝑜𝑠̧ 𝑔𝑒𝑙𝑑𝑖𝑛𝑖𝑧! 𝐾𝑜𝑚𝑢𝑡𝑙𝑎𝑟 𝑖𝑐̧𝑖𝑛 /komut 𝑌𝑎𝑝ı𝑛.")

@bot.message_handler(commands=['komut'])
def send_help_message(message):
    bot.reply_to(message, """
/adres 𝑘𝑜𝑚𝑢𝑡𝑢 𝑖𝑙𝑒 𝑇𝐶'𝑑𝑒𝑛 𝐴𝑑𝑟𝑒𝑠 𝐵𝑢𝑙𝑎𝑏𝑖𝑙𝑖𝑟𝑠𝑖𝑛.

/tc 𝐾𝑜𝑚𝑢𝑡𝑢 𝐾𝑢𝑙𝑙𝑎𝑛𝑎𝑟𝑎𝑘 𝐾𝑖𝑠̧𝑖 𝐵𝑖𝑙𝑔𝑖 𝐴𝑙𝑎𝑏𝑖𝑙𝑖𝑟𝑠𝑖𝑛.

/sorgu -Ad -Soyad -İl -İlce 𝑆𝑜𝑟𝑔𝑢𝑙𝑎𝑚𝑎 𝑌𝑎𝑝𝑎𝑟.

/aile 𝐾𝑜𝑚𝑢𝑡𝑢 𝑖𝑙𝑒 𝐴𝑖𝑙𝑒 𝑆𝑜𝑟𝑔𝑢𝑙𝑎𝑚𝑎 𝑌𝑎𝑝𝑎𝑟.

/ipadres 𝑖𝑙𝑒 𝑖𝑝 𝑆𝑜𝑟𝑔𝑢𝑙𝑎𝑚𝑎 𝑌𝑎𝑝𝑎𝑟.

/gsm 𝑖𝑙𝑒 𝑇𝑒𝑙 𝑁𝑜 𝑆𝑜𝑟𝑔𝑢𝑙𝑎𝑦𝑎𝑏𝑖𝑙𝑖𝑟𝑠𝑖𝑛𝑖𝑧.

/iban 𝑖𝑙𝑒 𝐼̇𝐵𝐴𝑁 𝐵𝑖𝑙𝑔𝑖𝑠𝑖 𝐴𝑙𝑎𝑏𝑖𝑙𝑖𝑟𝑠𝑖𝑛𝑖𝑧.
...
def adress_sorgu(message):
    try:
        ...
        if "success" in data and data["success"]:
            ...
            adres_message = f"""
𝐊𝐢𝐦𝐥𝐢𝐤 𝐍𝐨: {adres_data["KimlikNo"]}
𝗔𝗱 𝗦𝗼𝘆𝗮𝗱: {adres_data["AdSoyad"]}
𝗗𝗼𝗴̆𝘂𝗺 𝗬𝗲𝗿𝗶: {adres_data["DogumYeri"]}
𝗩𝗲𝗿𝗴𝗶 𝗡𝘂𝗺𝗮𝗿𝗮𝘀ı: {adres_data["VergiNumarasi"]}
𝗜̇𝗸𝗮𝗺𝗲𝘁𝗴𝗮𝗵: {adres_data["Ikametgah"]}
"""

            bot.reply_to(message, adres_message)
        else:
            bot.reply_to(message, "𝐵𝑢 𝑇𝐶 𝑛𝑢𝑚𝑎𝑟𝑎𝑠ı𝑛𝑎 𝑎𝑖𝑡 𝑎𝑑𝑟𝑒𝑠 𝑏𝑖𝑙𝑔𝑖𝑠𝑖 𝑏𝑢𝑙𝑢𝑛𝑎𝑚𝑎𝑑ı.")
    except IndexError:
        bot.reply_to(message, "𝐺𝑒𝑐̧𝑒𝑟𝑠𝑖𝑧 𝑘𝑜𝑚𝑢𝑡. 𝑘𝑢𝑙𝑙𝑎𝑛ı𝑚: /adres 12345678901")
...
"""
            ...
            bot.reply_to(message, "𝐵𝑢 𝑇𝐶 𝑛𝑢𝑚𝑎𝑟𝑎𝑠ı𝑛𝑎 𝑎𝑖𝑡 𝑣𝑒𝑟𝑖 𝑏𝑢𝑙𝑢𝑛𝑎𝑚𝑎𝑑ı.")
    except IndexError:
        bot.reply_to(message, "𝐺𝑒𝑐̧𝑒𝑟𝑠𝑖𝑧 𝑘𝑜𝑚𝑢𝑡. 𝑘𝑢𝑙𝑙𝑎𝑛ı𝑚: /tc 12345678901")
    ...
    try:
        ...
        if query:
            ...
            if "status" in data and data["status"] == "success":
                ...
                bot.reply_to(message, "𝐵𝑜̈𝑦𝑙𝑒 𝑏𝑖𝑟 𝑘𝑖𝑠̧𝑖 𝑏𝑖𝑙𝑔𝑖𝑠𝑖 𝑏𝑢𝑙𝑢𝑛𝑎𝑚𝑎𝑑ı.")
        else:
            bot.reply_to(message, "𝐺𝑒𝑐̧𝑒𝑟𝑠𝑖𝑧 𝑘𝑜𝑚𝑢𝑡. 𝑘𝑢𝑙𝑙𝑎𝑛ı𝑚: /sorgu -ad Adnan -soyad Oktar -il Karabük -ilce Merkez")
    except IndexError:
        bot.reply_to(message, "𝐺𝑒𝑐̧𝑒𝑟𝑠𝑖𝑧 𝑘𝑜𝑚𝑢𝑡 𝑘𝑢𝑙𝑙𝑎𝑛ı𝑚. /sorgu -ad Adnan -soyad Oktar -il Karabük -ilce Merkez")
...
def aile_sorgu(message):
    try:
        ...
        if "success" in data and data["success"]:
            ...
            bot.reply_to(message, "𝐴𝑖𝑙𝑒 𝑏𝑖𝑙𝑔𝑖𝑠𝑖 𝑏𝑢𝑙𝑢𝑛𝑎𝑚𝑎𝑑ı.")
    except IndexError:
        bot.reply_to(message, "𝐺𝑒𝑐̧𝑒𝑟𝑠𝑖𝑧 𝑘𝑜𝑚𝑢𝑡 𝑘𝑢𝑙𝑙𝑎𝑛ı𝑚: /aile 12345678901")
...
def iban_sorgu(message):
    try:
        ...
        if "Kod" in data:
            ...
            bot.reply_to(message, "𝐼𝐵𝐴𝑁 𝑏𝑖𝑙𝑔𝑖𝑠𝑖 𝑏𝑢𝑙𝑢𝑛𝑎𝑚𝑎𝑑ı.")
    except IndexError:
        bot.reply_to(message, "𝐺𝑒𝑐̧𝑒𝑟𝑠𝑖𝑧 𝑘𝑜𝑚𝑢𝑡 𝑘𝑢𝑙𝑙𝑎𝑛ı𝑚ı: /iban TR******")
...
def ip_sorgula(ip_adresi):
    try:
        ...
        zip_code = data['zip']
        return f"𝐈𝐏 𝐚𝐝𝐫𝐞𝐬𝐢: {ip_adresi}\n𝐔̈𝐥𝐤𝐞: {country}\n𝐁𝐨̈𝐥𝐠𝐞: {region}\n𝐒̧𝐞𝐡𝐢𝐫: {city}\n𝐙𝐈𝐏 𝐊𝐨𝐝𝐮: {zip_code}\n𝐈𝐒𝐏: {isp}\n𝐄𝐧𝐥𝐞𝐦: {latitude}\n𝐁𝐨𝐲𝐥𝐚𝐦: {longitude}\n𝐙𝐚𝐦𝐚𝐧 𝐃𝐢𝐥𝐢𝐦𝐢: {timezone}"
    except Exception as e:
        return f"𝐻𝑎𝑡𝑎𝑙ı 𝐼̇𝑃 𝐴𝑑𝑟𝑒𝑠𝑖!"
...
def handle_ipadres(message):
    try:
        ...
        bot.reply_to(message, f"𝑏𝑖𝑟 𝐼̇𝑃 𝐴𝑑𝑟𝑒𝑠𝑖 𝐺𝑖𝑟𝑚𝑒𝑙𝑖𝑠𝑖𝑛.")
...
𝐓𝐂: {gsm_detay["TC"]}
𝐀𝐝: {gsm_detay["ADI"]}
𝐒𝐨𝐲𝐚𝐝: {gsm_detay["SOYADI"]}
𝐃𝐨𝐠̆𝐮𝐦 𝐓𝐚𝐫𝐢𝐡𝐢: {gsm_detay["DOGUMTARIHI"]}
𝐍𝐮̈𝐟𝐮𝐬 𝐈̇𝐋: {gsm_detay["NUFUSIL"]}
𝐍𝐮̈𝐟𝐮𝐬 𝐈̇𝐋𝐜̧𝐞: {gsm_detay["NUFUSILCE"]}
𝐀𝐧𝐧𝐞 𝐀𝐝ı: {gsm_detay["ANNEADI"]}
𝐀𝐧𝐧𝐞 𝐓𝐂: {gsm_detay["ANNETC"]}
𝐁𝐚𝐛𝐚 𝐀𝐝ı: {gsm_detay["BABAADI"]}
𝐁𝐚𝐛𝐚 𝐓𝐂: {gsm_detay["BABATC"]}
𝐔𝐲𝐫𝐮𝐤: {gsm_detay["UYRUK"]}
"""
            return gsm_mesaj
        else:
            return "𝐵𝑢 𝐺𝑆𝑀 𝑛𝑢𝑚𝑎𝑟𝑎𝑠ı𝑛𝑎 𝑎𝑖𝑡 𝑏𝑖𝑙𝑔𝑖 𝑏𝑢𝑙𝑢𝑛𝑎𝑚𝑎𝑑ı."
    except Exception as e:
        return f"𝐺𝑆𝑀 𝑠𝑜𝑟𝑔𝑢𝑙𝑎𝑛ı𝑟𝑘𝑒𝑛 𝑏𝑖𝑟 ℎ𝑎𝑡𝑎 𝑜𝑙𝑢𝑠̧𝑡𝑢."
...
def send_sms(message):
    ...
    if len(args) != 2:
        bot.reply_to(message, "𝐺𝑆𝑀 𝑣𝑒 𝐴𝑑𝑒𝑡 𝐺𝑖𝑟𝑖𝑛 𝑂̈𝑟𝑛: 555* 10")
        return
    phone_number = args[0]
